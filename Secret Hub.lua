...
mainopens.Parent = mainopen
 ...
 do  local ui =  game:GetService("CoreGui").RobloxGui.Modules:FindFirstChild("SecretHub")  if ui then ui:Destroy() end end
 ...
 local SecretHub = Instance.new("ScreenGui")
 SecretHub.Name = "SecretHub"
 SecretHub.Parent = game.CoreGui
 SecretHub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
 
 local Main = Instance.new("Frame")
 Main.Name = "Main"
 Main.Parent = SecretHub
...
NotificationHold.Parent = SecretHub
...
--------------------------------------------------------------------
local Library = Update:Window("Secrets HUB ","")
------------------------------------------
